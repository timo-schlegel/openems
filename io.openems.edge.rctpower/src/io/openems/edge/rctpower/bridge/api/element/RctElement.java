...
import io.openems.edge.rctpower.bridge.api.task.AbstractTask;
 ...
 */
public abstract sealed class RctElement permits AbstractRctElement {
	...
	public RctElement(int startAddress, int length) {
	 ...
	 */
	public abstract void invalidate(AbstractRctPowerBridge bridge);
	 ...
	 */
	public final void setRctTask(Task task) {
		this.task = task;
	}

	public final Task getRctTask() {
		return this.task;
	}
